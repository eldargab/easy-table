  ...
  this.rows.forEach(function(row) {
    ...
    cols.forEach(function(key) {
      ...
      var str = row.hasOwnProperty(key)
        ...
        : ''
      line += padRight(str, width) + shift
    })
    line = line.slice(0, -shift.length)
    out += line + '\n'
  })
...
Table.prototype.copyOptions = function(t) {
  this.shift = t.shift
  return this
}
...
Table.prototype.toString = function() {
  var cols = this.columns()
  var out = new Table().copyOptions(this)
  ...
  cols.forEach(function(col) {
    out.cell(col, undefined, leftPadder('-'))
  })
